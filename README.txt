...
a persistence unit "primefaces-pocsPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "primefaces-pocs/pom.xml":
...
artifacts ("primefaces-pocs-ejb.jar" and "primefaces-pocs-web.war") are already built. You can build
